...
#输入门店名称
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[1]/form/div[2]/div/div[1]/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[0])
...
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[1]/form/div[6]/div/div[2]/div/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[1])
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[1]/form/div[7]/div/div[1]/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[2])
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[1]/form/div[8]/div/div/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[3])
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[2]/form/div[1]/div/div[1]/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[4])
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[2]/form/div[2]/div/div/input').send_keys(data.read_excela(r'D:\Python project\yunyingpingtai\excel\test_md1.xls')[5])
