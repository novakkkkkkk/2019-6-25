...
#输入门店名称
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[1]/form/div[2]/div/div[1]/input').send_keys('zdhmd005')
...
driver.find_element_by_xpath('//*[@id="companyinfos_box"]/div[2]/form/div[1]/div/div[1]/input').send_keys('mendian-zdhmd5')
