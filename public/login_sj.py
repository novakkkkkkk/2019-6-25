...
def login(driver):
    ...
    driver.find_element_by_xpath("//*[@id='app']/div/div/div[2]/div[2]/div[3]/form/div[1]/div/div/div[1]/input").send_keys('金康开发平台')
    driver.find_element_by_xpath("//*[@id='app']/div/div/div[2]/div[2]/div[3]/form/div[2]/div/div/div/input").send_keys('jkkf')
